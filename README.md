...
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/YoussefAshraf711)
...
| 🧠 AI & Data Science Roadmap | 🐧 Linux & CS Guides |
| :--- | :--- |
| A structured, open-source learning path covering Math, ML, Deep Learning, and MLOps engineering. | Comprehensive guides for System Administration (Fedora) and bilingual Computer Science resources. |

| 🍲 Global Cuisine Predictor | 🌲 Interactive Decision-Tree Game |
| :--- | :--- |
| ML tool predicting international dishes based on large recipe databases using Scikit-Learn. | Console application utilizing smart binary decision trees with adaptive learning algorithms. |
